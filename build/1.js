...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__tabs__ = __webpack_require__(352);
...
var TabsPage = (function () {
    ...
    TabsPage.prototype.ionViewDidLoad = function () {
        ...
        if (this.app.getActiveNavs().length > 1)
            this.navCtrl.remove(0, this.app.getActiveNavs().length);
    };
    TabsPage.prototype.ionViewWillEnter = function () {
    };
    TabsPage.prototype.ionViewDidEnter = function () {
    };
    TabsPage.prototype.switchTabs = function (index) {
    };
    __decorate([
